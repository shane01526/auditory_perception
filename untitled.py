...
print('audioLatencyMode:', prefs.hardware['audioLatencyMode'])
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    sound.Sound._audioDeviceSampleRateHz = 44100
    ...
    for thisBlock in blocks:
        ...
        _break_key_allKeys = []
        # keep track of which components have finished
        block_breakComponents = [break_text, break_key]
        ...
        for thisTrial in trials:
            ...
            _key_resp_allKeys = []
            # keep track of which components have finished
            trialComponents = [text, sound_1, sound_2, text_2, key_resp]
            ...
            while continueRoutine:
                ...
                if sound_2.status == NOT_STARTED and tThisFlip >= 2.5-frameTolerance:
                    # keep track of start time/frame for later
